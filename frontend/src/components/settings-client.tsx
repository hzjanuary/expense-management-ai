      ...
      <section className={panelClassName}>
        ...
        <div className="mt-3 grid gap-3 text-sm leading-6 text-ledger-muted">
          <p>
            ...
            cầu AI trả về trạng thái không khả dụng an toàn thay vì tạo số liệu
            tài chính mẫu.
          </p>
          <p>
            Model được khuyến nghị cho cấu hình cục bộ hiện tại:{" "}
          ...
          <div className="rounded-md border border-ledger-line bg-ledger-wash p-3">
            <p className="font-semibold text-ledger-ink">
              Chuẩn bị Ollama trên máy cá nhân
            </p>
...
ollama serve`}
          ...
          <p>
            Ứng dụng không tự tải model trong Docker build, khi khởi động, khi
            chạy test hoặc khi chạy E2E.
          </p>
        </div>
      </section>
      ...
      <section className={panelClassName}>
        ...
        <div className="mt-3 grid gap-3 text-sm leading-6 text-ledger-muted">
          ...
          <p>
            ...
            là thao tác phá hủy volume và xóa dữ liệu cục bộ.
          </p>
          <a
            ...
            target="_blank"
          >
            Xem hướng dẫn xử lý sự cố trong tài liệu
          </a>
        </div>
      </section>
